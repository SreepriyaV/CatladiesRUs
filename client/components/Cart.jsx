...
class Cart extends Component {
  ...
  changeQuantity(event) {
    ...
    const quantity = this.state.quantity.length
      ? this.state.quantity
      : this.props.quantity;
  ...
  render() {
    ...
    let quantity = this.state.quantity.length
      ? this.state.quantity
      : this.props.quantity;
            ...
            return (
              <div key={index}>
                ...
                <button
                  ...
                  value={index}
                  onClick={this.changeQuantity}
                  disabled={quantity[index] === cat.quantity}
                >
                  +
                </button>
                <button
                  onClick={() =>
                    this.props.removeCatFromCart(cat, this.props.cart)}
                >
        ...
        <div>
          <Link to="/cart/purchase">
            <button
              type="submit"
              onClick={() =>
                this.handlePurchase(cart, quantity, subtotal, userId)}
            >
